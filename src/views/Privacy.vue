  ...
  <v-container>
    <div class="d-flex justify-center">
      <v-card flat class="py-6 px-10" rounded="lg" width="1024px" fluid>
        ...
        <p>AoE4 Guides operates the www.aoe4guides.com website, which provides the SERVICE.</p>

        <p>
          This page is used to inform website visitors regarding our policies with the collection,
          use, and disclosure of Personal Information if anyone decided to use our Service, the AoE4
          Guides website.
        </p>
        ...
        <p>
          ...
          Conditions, which is accessible at www.aoe4guides.com, unless otherwise defined in this
          Privacy Policy.
        </p>
        <br />
        ...
        <p>
          ...
          contact us.<br />(via mail: info (at) aoe4guides (dot) com)
        </p>
      </v-card>
    </div>
  </v-container>
