...
export default function useIconService(civArg) {
  ...
  const building_tech = [
    ...
    },
    {
      ...
      civ: ["ENG", "FRE", "JDA", "RUS", "OTT", "CHI", "HRE"],
      class: "tech",
    },
    {
      title: "Madrasa",
  ...
  const unit_religious = [
    {
      ...
      civ: ["ENG", "FRE", "JDA", "RUS", "MAL", "MON", "CHI", "HRE"],
      class: "military",
    },
    {
      title: "Imam",
  ...
  const unit_military = [
    ...
    },
    {
      ...
      civ: ["ENG", "RUS", "MON", "ABB", "AYY", "OTT", "CHI", "DEL", "HRE"],
      class: "military",
    },
    {
      title: "Handcannoneer",
      ...
      civ: ["ENG", "FRE", "JDA", "MON", "ABB", "AYY", "CHI", "DEL", "HRE"],
      class: "military",
    },
    {
      title: "Spearman",
      ...
      civ: ["ENG", "FRE", "JDA", "RUS", "MON", "ABB", "AYY", "OTT", "CHI", "DEL", "HRE"],
      class: "military",
    },
    {
    ...
    },
    {
      ...
      civ: ["ENG", "FRE", "JDA", "RUS", "MON", "OTT", "CHI", "HRE"],
      class: "military",
    },
    {
      title: "Ghazi Raider",
    ...
    },
    {
      ...
      civ: ["ENG", "RUS", "MAL", "MON", "ABB", "AYY", "CHI", "DEL", "HRE"],
      class: "military",
    },
    {
      title: "Ribauldequin",
