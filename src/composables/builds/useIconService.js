...
export default function useIconService(civArg) {
  ...
  const building_religious = [
    {
      ...
      civ: ["ENG", "FRE", "JDA", "RUS", "CHI", "ZXL", "HRE"],
      class: "default",
    },
    {
      title: "Mosque",
  ...
  const building_tech = [
    ...
    },
    {
      ...
      civ: ["ENG", "FRE", "JDA", "RUS", "OTT", "CHI", "ZXL", "HRE"],
      class: "tech",
    },
    {
      title: "Madrasa",
  ...
  const unit_religious = [
    {
      ...
      civ: ["ENG", "FRE", "JDA", "RUS", "MAL", "MON", "CHI", "ZXL", "HRE"],
      class: "military",
    },
    {
      title: "Imam",
  ...
  const unit_military = [
    ...
    },
    {
      ...
      civ: ["ENG", "RUS", "MON", "ABB", "AYY", "OTT", "CHI", "ZXL", "DEL", "HRE"],
      class: "military",
    },
    {
      title: "Handcannoneer",
      ...
      civ: ["ENG", "FRE", "JDA", "MON", "ABB", "AYY", "CHI", "ZXL", "DEL", "HRE"],
      class: "military",
    },
    {
      title: "Spearman",
      ...
      civ: ["ENG", "FRE", "JDA", "RUS", "MON", "ABB", "AYY", "OTT", "CHI", "ZXL", "DEL", "HRE"],
      class: "military",
    },
    {
    ...
    },
    {
      ...
      civ: ["ENG", "FRE", "JDA", "RUS", "MON", "OTT", "CHI", "ZXL", "HRE"],
      class: "military",
    },
    {
      title: "Ghazi Raider",
    ...
    },
    {
      ...
      civ: ["ENG", "RUS", "MAL", "MON", "ABB", "AYY", "CHI", "ZXL", "DEL", "HRE"],
      class: "military",
    },
    {
      title: "Ribauldequin",
